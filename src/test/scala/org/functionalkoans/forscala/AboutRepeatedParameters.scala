...
class AboutRepeatedParameters extends KoanSuite {
  ...
  val resultString = "3 eggs can give you a delicious sandwich, protein, high cholesterol"
  ...
  koan( """A repeated parameter must be the last parameter and this will
    ...
    repeatedParameterMethod(3, "egg", "a delicious sandwich", "protein", "high cholesterol") should be(resultString)
  }
  ...
  koan("A repeated parameter can accept a collection,and if you want it expanded, add :_*") {
    repeatedParameterMethod(3, "egg", List("a delicious sandwich", "protein", "high cholesterol"):_*) should be(resultString)
  }
}
